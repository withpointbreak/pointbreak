...
pub use workflow::{
    ...
    BulkAdoptionRetainedManifestV1, CHANGE_OPERATION_SCHEMA_V1, CaptureDiffstat, CaptureOptions,
    CaptureResult, ChangeAdvanceV1, ChangeCaptureOptions, ChangeCaptureReceiptV1,
