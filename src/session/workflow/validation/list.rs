...
pub fn list_validation_checks_with_public_read_context(
    ...
    list_validation_checks_with_public_read_context_and_fact_reader(
        options,
        context,
...
#[cfg(test)]
pub(in crate::session::workflow) fn list_validation_checks_with_public_read_context_and_fact_hook(
    options: ValidationListOptions,
    context: PublicReadCommandContextV1,
...
fn list_validation_checks_with_public_read_context_and_fact_reader(
    options: ValidationListOptions,
    context: PublicReadCommandContextV1,
