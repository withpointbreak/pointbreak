...
pub(crate) use backend::GitObjectPolicy;
...
pub(crate) use command::{
    Ancestry, git_commit_changed_paths, git_commit_endpoint, git_commit_parent_oids,
    git_commit_tree_oid, git_common_dir, git_config_get, git_config_path_get,
    git_default_branch_ref, git_empty_tree_oid, git_for_each_ref, git_head_commit_oid_optional,
    git_head_oid, git_head_ref, git_independent_commits, git_is_ancestor,
    git_is_ancestor_with_policy, git_object_exists, git_path_is_untracked, git_paths_are_ignored,
...
pub(crate) use ingest::{
    capture_commit_range_diff_files, capture_commit_range_diff_files_with_policy,
    capture_root_commit_diff_files, capture_staged_diff_files, capture_unstaged_diff_files,
    capture_worktree_diff_files, capture_worktree_diff_files_from_base,
};
