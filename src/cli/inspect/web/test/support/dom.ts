...
<header id="topbar">
  ...
  <div class="stats">
    ...
    <div class="timeline-boundary-controls" role="group" aria-label="stream position">
      <button id="jump-start" class="ghost" type="button">start</button>
      <button id="jump-end" class="ghost" type="button">end</button>
      <button id="follow-toggle" class="ghost" type="button" aria-pressed="true">follow</button>
    </div>
    <button id="timeline-new-pill" class="ghost timeline-new-pill hidden" type="button">0 new ↑</button>
...
<div id="reconnect-dialog" class="modal hidden" role="dialog" aria-modal="true" aria-labelledby="reconnect-title">
  <div class="modal-card reconnect-card">
    ...
    <div class="reconnect-actions">
      ...
      <button id="reconnect-submit" type="button">Reconnect</button>
    </div>
  </div>
</div>
`;
