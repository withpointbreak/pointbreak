...
<div id="key-help" class="modal hidden" role="dialog" aria-modal="true" aria-label="Keyboard shortcuts">
  <div class="modal-card key-help-card">
    ...
    <dl class="key-help-list">
      ...
      <dt><kbd>j</kbd> / <kbd>k</kbd></dt><dd>move the local event or Change cursor; an open event detail follows the cursor</dd>
      ...
      <dt><kbd>g</kbd> / <kbd>G</kbd></dt><dd>move to the first / last filtered event or Change; inside an open event detail, the first / last event of the loaded page</dd>
      <dt><kbd>Shift</kbd> + <kbd>F</kbd></dt><dd>follow or park the filtered Timeline head</dd>
      <dt><kbd>Enter</kbd></dt><dd>open the selected event or Change; from an open event detail, descend into its annotated diff, or choose an explicit current Revision from exact detail</dd>
