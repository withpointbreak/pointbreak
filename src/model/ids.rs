...
id_type!(ObjectId);
id_type!(ChangeId);
id_type!(ChangeDeclarationClaimId);
id_type!(ChangeMembershipClaimId);
id_type!(ChangeMembershipWithdrawalId);
id_type!(ChangeLinkClaimId);
id_type!(ChangeRevisionRelationClaimId);
id_type!(ChangeRevisionRelationWithdrawalId);
id_type!(RevisionRelationAttestationId);
id_type!(ReviewFactPortId);
id_type!(HunkId);
id_type!(RowId);
id_type!(ActorId);
id_type!(TrackId);
